...
[{
	...
	[_posASL, _surfaceNormal, _intersectObject, _unit] spawn grad_welder_fnc_sparkClient;
	[_posASL, _surfaceNormal, _intersectObject, _finalPoint, _unit] call grad_welder_fnc_lightClient;
